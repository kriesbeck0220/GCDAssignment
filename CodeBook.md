## This is the Code Book for Coursera Getting and Cleaning Data Week 3 Assignement Submission.

### Raw data set description from the UCI HAR Dataset source:
...
2.56 sec and 50% overlap (128 readings/window). The sensor acceleration signal, which has gravitational and body motion components, 
...
The following files are contained:
	...
	*tidy_WALKING_UPSTAIRS.txt

	*tidy_WALKING_DOWNSTAIRS.txt
...
*Only the mean and standard deviation variable measurements were extracted from the raw data set.  

*The averages of the remaining variables (n = 86) were then taken for each subject (1 through 30) and for each Activity (n = 6).

*The data set was broken down into 6 tables, one for each type of the 6 Activities (WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING)